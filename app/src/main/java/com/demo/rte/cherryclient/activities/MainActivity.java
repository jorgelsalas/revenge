...
public class MainActivity extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position) {
            case 0:
                fragment = new TestSetUpFragment();
                fragmentID = getString(R.string.test_set_up_fragment_id);
                break;
            case 1:
                fragment = new CompletedTestsFragment();
                fragmentID = getString(R.string.completed_tests_fragment_id);
                break;
            case 2:
                fragment = new TestResultsFragment();
                fragmentID = getString(R.string.test_results_fragment_id);
                break;

            default:
                fragment = new PlaceholderFragment();
                fragmentID = getString(R.string.placeholder_fragment_id);
                break;
        }
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 0:
                mTitle = getString(R.string.test_set_up_fragment_title);
                break;
            case 1:
                mTitle = getString(R.string.completed_tests_fragment_title);
                break;
            case 2:
                mTitle = getString(R.string.test_results_fragment_title);
                break;
        }
    }
